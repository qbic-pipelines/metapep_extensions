...
def main(args=None):
    ...
    # validate input AAs (Filter out all proteins with invalid letters)
    ...
    print(f"Info: {filtered_count} valid proteins retained after filtering.")
    print(f"Info: {initial_count - filtered_count} proteins removed due to invalid amino acids.")
    # get protein lengths
